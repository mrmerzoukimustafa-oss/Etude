...
def dimensionnement_cable(ib, mode_pose, longueur, cos_phi=0.9):
...
if type_ouvrage == "Raccordement BT souterrain":
    ...
    section, iz, du = dimensionnement_cable(ib, mode_pose, longueur, cos_phi)
    ...
    ib = calcul_courant(puissance, tension, cos_phi)
    section, iz, du = dimensionnement_cable(ib, "aérien", longueur, cos_phi)
